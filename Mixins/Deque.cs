...
namespace IngameScript
{
    public partial class Program
    {
        ...
        /// <remarks>
        /// Adapted from https://github.com/StephenCleary/Deque
        /// </remarks>
        public sealed partial class Deque<T> : IList<T>, IReadOnlyList<T>
        {
            /// <summary>
            ...
            {
                if (capacity < 0)
                    throw new ArgumentException("Capacity may not be negative.", nameof(capacity));
            ...
            /// <exception cref="ArgumentException"><paramref name="index"/> is not a valid index to an insertion point for the source.</exception>
            private static void CheckNewIndexArgument(int sourceLength, int index)
            {
                if (index < 0 || index > sourceLength)
                {
                    throw new ArgumentException("Invalid new index " + index + " for source length " + sourceLength, nameof(index));
                }
            }
            ...
            /// <param name="sourceLength">The length of the source. This parameter is not checked for validity.</param>
            /// <param name="index">The index into the source.</param>
            /// <exception cref="ArgumentException"><paramref name="index"/> is not a valid index to an existing element for the source.</exception>
            private static void CheckExistingIndexArgument(int sourceLength, int index)
            {
                if (index < 0 || index >= sourceLength)
                {
                    throw new ArgumentException("Invalid existing index " + index + " for source length " + sourceLength, nameof(index));
                }
            }
            ...
            /// <exception cref="ArgumentException">Either <paramref name="offset"/> or <paramref name="count"/> is less than 0.</exception>
            ...
            public int Capacity
            {
                ...
                {
                    if (value < Count)
                        throw new ArgumentException("Capacity cannot be set to a value less than Count", nameof(value));
            ...
            private static IReadOnlyCollection<T> ReifyCollection(IEnumerable<T> source)
            {
                if (source == null)
                ...
                if (nongenericCollection != null)
                    return new NongenericCollectionWrapper(nongenericCollection);
